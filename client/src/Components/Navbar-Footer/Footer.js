    ...
    return (
      <div className="footer-outer">
        ...
        >
            ...
            <div className="sub-section">
              ...
              <div className="section-3">
                ...
                <p>
                  ...
                  Mathabhanga(736146),Coochbehar,India
                </p>
                <p>
                  <i className="fas fa-envelope me-3"></i>
                  Codecuriofficial@gmail.com
                </p>
                <p>
                  <i className="fas fa-phone me-3"></i>+91 9851171483
                </p>
                {/* <p>
          ...
          >
            © 2022 Copyright:&nbsp;
            <a className="text-reset fw-bold" href="https://codecuri.com/">
              codecuri.com
            </a>
          </div>
        </MDBFooter>
